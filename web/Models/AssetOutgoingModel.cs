...
{
    public class AssetOutgoingModel
    {
        [Required]
        ...
        public string fldOutgoingByCode { get; set; }
        public List<DropDown> cbOutgoingBy { get; set; }

        [DataType(DataType.Date)]
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:yyyy-MM-dd}")]
        [Display(Name = "Released Date")]
        public DateTime fldOutgoingDateTime { get; set; }
