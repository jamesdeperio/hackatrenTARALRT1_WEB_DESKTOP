...
{
    public class AssetIncomingModel
    {
        [Required]
        ...
        public string fldIncomingByCode { get; set; }
        public List<DropDown> cbIncomingBy { get; set; }

        [DataType(DataType.Date)]
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:yyyy-MM-dd}")]
        [Display(Name = "Received Date")]
        public DateTime fldIncomingDateTime { get; set; }
