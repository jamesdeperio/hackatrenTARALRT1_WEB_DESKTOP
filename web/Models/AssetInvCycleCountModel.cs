...
{
    public class AssetInvCycleCountModel
    {
        [Required]
        ...
        [StringLength(200)]
        [Display(Name = "Rack")]
        public string fldRackName { get; set; }
        ...
        [StringLength(200)]
        [Display(Name = "Shelf")]
        public string fldShelfName { get; set; }
        ...
        public string fldInvCycleCountByCode { get; set; }
        public List<DropDown> cbInvCycleCountBy { get; set; }

        [DataType(DataType.Date)]
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:yyyy-MM-dd}")]
        [Display(Name = "Released Date")]
        public DateTime fldInvCycleCountDateTime { get; set; }
